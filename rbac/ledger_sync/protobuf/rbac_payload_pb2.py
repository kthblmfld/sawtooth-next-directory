...
_RBACPAYLOAD_MESSAGETYPE = _descriptor.EnumDescriptor(
  name='MessageType',
  full_name='protos.RBACPayload.MessageType',
  filename=None,
  file=DESCRIPTOR,
  values=[
...
_RBACPAYLOAD = _descriptor.Descriptor(
  name='RBACPayload',
  full_name='protos.RBACPayload',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='message_type', full_name='protos.RBACPayload.message_type', index=0,
    ...
    _descriptor.FieldDescriptor(
      name='content', full_name='protos.RBACPayload.content', index=1,
...
RBACPayload = _reflection.GeneratedProtocolMessageType('RBACPayload', (_message.Message,), dict(
  ...
  # @@protoc_insertion_point(class_scope:protos.RBACPayload)
  ))
